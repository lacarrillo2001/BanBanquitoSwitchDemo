package com.banquito.switchpagos.parameter.constants;

public final class CodigoParametroSwitch {

    public static final String IVA_PORCENTAJE = "IVA_PORCENTAJE";
    public static final String HORA_CORTE_PROCESO = "HORA_CORTE_PROCESO";
